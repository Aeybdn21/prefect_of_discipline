...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('pd_investigations', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('categorize_id')->references('id')->on('pd_categorize_cases')->onDelete('cascade');
            ...
            $table->foreign('investigate_status_id')->references('id')->on('pd_status_investigations')->onDelete('cascade');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('pd_investigations');
    }
};
