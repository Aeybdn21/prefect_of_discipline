...
function LabelSelect(props) {  
  const {disabled, onChange, setData} = props;
  return (
    <div className={classNames('my-2 ',)}>  
        <select disabled={disabled} onChange={onChange} defaultValue={disabled && 0} id="selected-parties" 
            className={classNames('w-full lg:w-1/3 text-sm', 'rounded-lg border-gray-300', 
                'text-base p-2 px-2', 'transform ease-in duration-200', disabled && 'bg-gray-200 text-black/40', !disabled && 'text-black/70')}>
